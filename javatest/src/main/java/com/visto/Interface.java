...
//Classe destinada a exibir os dados de forma organizada para o leitor.
public class Interface {
    public static void showLinha() {
        System.out.println("====================================================================================");
    }

    public static void showCartaoPessoa(String nome, String sobreNome, String funcao, String empresa, String veiculo,
            double peso, double altura, String marcaVeiculo) {
        showLinha();
    ...
    public static void showMaiorAltura(String nome, String sobrenome, double altura) {
        altura = altura / 100;
        showLinha();
        System.out.println(" Pessoa com maior altura: " + nome + " " + sobrenome + " com " + altura + "M");
        showLinha();
    }

    public static void showObesidade() {
        showLinha();
        System.out.println(" Pessoas com obesidade: ");
    }
